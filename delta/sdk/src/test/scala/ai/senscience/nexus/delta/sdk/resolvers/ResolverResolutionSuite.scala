...
import ai.senscience.nexus.delta.sdk.generators.ResolverGen
...
import ai.senscience.nexus.delta.sdk.resolvers.ResolverResolutionSuite.ResourceExample
import ai.senscience.nexus.delta.sdk.resolvers.model.IdentityResolution.{ProvidedIdentities, UseCurrentCaller}
import ai.senscience.nexus.delta.sdk.resolvers.model.Resolver.CrossProjectResolver
