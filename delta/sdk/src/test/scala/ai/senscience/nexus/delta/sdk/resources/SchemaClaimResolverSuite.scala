...
import ai.senscience.nexus.delta.sdk.resources.model.ResourceRejection.{SchemaIsDeprecated, SchemaIsMandatory}
...
class SchemaClaimResolverSuite extends NexusSuite with RemoteContextResolutionFixtures {
