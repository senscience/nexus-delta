...
import ai.senscience.nexus.delta.plugins.elasticsearch.model.ElasticSearchViewValue.IndexingElasticSearchViewValue.defaultPipeline
...
sealed trait ElasticSearchViewValue extends Product with Serializable {
  ...
  def toJson(iri: Iri): Json = {
    import ai.senscience.nexus.delta.plugins.elasticsearch.model.ElasticSearchViewValue.Source.*
