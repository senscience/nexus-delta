...
import ai.senscience.nexus.delta.plugins.elasticsearch.model.ElasticSearchViewCommand.*
...
import ai.senscience.nexus.delta.plugins.elasticsearch.model.ElasticSearchViewType.{AggregateElasticSearch, ElasticSearch}
