...
import ai.senscience.nexus.delta.plugins.compositeviews.indexing.{commonNamespace, projectionIndex, projectionNamespace}
import ai.senscience.nexus.delta.plugins.compositeviews.model.CompositeIndexingDescription.ProjectionSpace.{ElasticSearchSpace, SparqlSpace}
...
import ai.senscience.nexus.delta.plugins.compositeviews.model.{CompositeIndexingDescription, CompositeViewSource, ProjectionOffset, ProjectionStatistics}
...
import ai.senscience.nexus.delta.sdk.views.IndexingViewRef
