...
object Archive {
  ...
  object Metadata {
    ...
    given JsonLdEncoder[Metadata] = JsonLdEncoder.computeFromCirce(ContextValue(contexts.archivesMetadata))
  }

  private given Encoder.AsObject[Archive] = {
  ...
  given JsonLdEncoder[Archive] = JsonLdEncoder.computeFromCirce(ContextValue(contexts.archives))
