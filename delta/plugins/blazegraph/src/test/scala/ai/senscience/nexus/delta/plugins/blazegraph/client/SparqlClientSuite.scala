...
import ai.senscience.nexus.delta.plugins.blazegraph.client.PatchStrategy.{keepPredicates, removePredicates}
import ai.senscience.nexus.delta.plugins.blazegraph.client.SparqlClientError.SparqlQueryError
import ai.senscience.nexus.delta.plugins.blazegraph.client.SparqlQueryResponse.SparqlResultsResponse
