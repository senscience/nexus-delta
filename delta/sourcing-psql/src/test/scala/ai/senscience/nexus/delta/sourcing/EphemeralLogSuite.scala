...
import ai.senscience.nexus.delta.sourcing.Message.MessageRejection.{AlreadyExists, MessageTooLong, NotFound}
import ai.senscience.nexus.delta.sourcing.Message.{CreateMessage, MessageRejection, MessageState}
