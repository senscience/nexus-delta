...
DROP TABLE    IF EXISTS public.projection_terminations;
DROP TABLE    IF EXISTS public.elasticsearch_running_views;
DROP TABLE    IF EXISTS public.blazegraph_running_views;
