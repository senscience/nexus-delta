...
@link:[Python with Boto3](https://boto3.amazonaws.com/v1/documentation/api/latest/guide/s3-uploading-files.html){ open=new } that illustrate the process of doing a multipart upload to S3.
