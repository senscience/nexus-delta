...
@link:[Python with Boto3](https://docs.aws.amazon.com/boto3/latest/guide/s3-uploading-files.html){ open=new } that illustrate the process of doing a multipart upload to S3.
